package com.example.jorge.tadm_persistenciaarchivos_jorgedanielrubio;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botonSave= findViewById(R.id.btnSave);
        botonLoad= findViewById(R.id.btnLoad);
            ...
            public void onClick(View v) {
                ...
                if(sdDisponible&&sdEscritura){
                    try{
                        ...
                        fout.write(str);
                        fout.close();
                        Toast.makeText(MainActivity.this,"S guardo exitosamente", Toast.LENGTH_SHORT).show();
                    }catch (Exception e){
